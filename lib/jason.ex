defmodule LosslessJason do
  @moduledoc """
  A blazing fast JSON parser and generator in pure Elixir.
  """

  alias LosslessJason.{Encode, Decoder, DecodeError, EncodeError, Formatter}
  ...
  ## Examples
      ...
      iex> LosslessJason.decode("{}")
      {:ok, %{}}

      iex> LosslessJason.decode("invalid")
      {:error, %LosslessJason.DecodeError{data: "invalid", position: 0, token: nil}}
  """
  ...
  ## Examples
      ...
      iex> LosslessJason.decode!("invalid")
      ** (LosslessJason.DecodeError) unexpected byte at position 0: 0x69 ('i')
  ...
  The generation is controlled by the `LosslessJason.Encoder` protocol,
  ...
  ## Options
    ...
    * `:pretty` - controls pretty printing of the output. Possible values are:
      ...
      * a keyword of options as specified by `LosslessJason.Formatter.pretty_print/2`.

  ## Examples

      iex> LosslessJason.encode(%{a: 1})
      {:ok, ~S|{"a":1}|}

      iex> LosslessJason.encode("\\xFF")
      {:error, %LosslessJason.EncodeError{message: "invalid byte 0xFF in <<255>>"}}
  ...
  ## Examples
      ...
      iex> LosslessJason.encode!("\\xFF")
      ** (LosslessJason.EncodeError) invalid byte 0xFF in <<255>>
  ...
  ## Examples
      ...
      iex> {:ok, iodata} = LosslessJason.encode_to_iodata(%{a: 1})
      iex> IO.iodata_to_binary(iodata)
      ~S|{"a":1}|

      iex> LosslessJason.encode_to_iodata("\\xFF")
      {:error, %LosslessJason.EncodeError{message: "invalid byte 0xFF in <<255>>"}}
  ...
  ## Examples
      ...
      iex> iodata = LosslessJason.encode_to_iodata!(%{a: 1})
      iex> IO.iodata_to_binary(iodata)
      ~S|{"a":1}|
